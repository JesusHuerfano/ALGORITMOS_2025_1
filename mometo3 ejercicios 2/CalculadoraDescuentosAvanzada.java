public class CalculadoraDescuentosAvanzada {
    ...
    public static double calcularPrecioFinal(double precioOriginal, String categoriaProducto, int cantidad, boolean esVIP) {
        ...
        double precioTrasCategoria = precioOriginal * (1 - descuentoCategoria);

        double descuentoVolumen = obtenerPorcentajeDescuentoVolumen(cantidad);
        double precioTrasVolumen = precioTrasCategoria * (1 - descuentoVolumen);

        double descuentoVIP = obtenerPorcentajeDescuentoVIP(esVIP);
        double precioFinal = precioTrasVolumen * (1 - descuentoVIP);
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Precio Final Esperado: $" + (precioLaptop1 * 0.90));
        ...
        System.out.println("Precio Final Esperado: $" + (50.00 * 0.80 * 0.95));
        ...
        System.out.println("Precio Final Esperado: $" + (20.00 * 0.95 * 0.90 * 0.93));
        ...
        System.out.println("Precio Final Esperado: $" + (30.00 * 1.0 * 1.0 * 0.93));
